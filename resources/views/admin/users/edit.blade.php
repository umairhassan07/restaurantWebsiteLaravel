...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="{{ route('update-user', ['id' => $user['id'] ] ) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="row mb-5">
                <div class="col-md-4">
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="image-container parent" >
                        <img id="blah" src="{{ asset('images/users/'.$user['image']) }}" alt="user image" class="child-right" style="object-fit:contain;" />
                    </div>
          ...
          <button type="submit" id="submit_button" class="btn btn-primary me-2">Update User</button>
